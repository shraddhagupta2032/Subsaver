...
export const AddSubscriptionScreen = ({ navigation }) => {
  ...
  const setPresetDate = (monthsToAdd = 1, daysToAdd = 0) => {
    const d = new Date();
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      await subscriptionsApi.createSubscription(payload);
      Alert.alert('Success', `${name.trim()} subscription created successfully!`, [
        {
          text: 'OK',
      ...
      console.warn('createSubscription error:', err);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Card style={styles.card}>
          ...
          <Input
            ...
            placeholder="Account email, login method, or plan tier"
            value={notes}
          ...
          <Button
            title={loading ? 'Saving...' : 'Save Subscription'}
